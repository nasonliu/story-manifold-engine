...
TURNING_POINTS: 根据故事情节生成3-5个0-1之间的转折点位置（如0.15, 0.35, 0.55, 0.75）
CLIMAX_POSITION: 0.7
TENSION_CURVE: 根据故事情节生成10个0-1之间的浮点数，真实反映故事张力变化（如0.1,0.2,0.3,0.5,0.7,0.9,1.0,0.7,0.5,0.3 或 0.2,0.3,0.5,0.4,0.6,0.8,0.9,0.7,0.4,0.2）
